...
export const betPointsAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'name', internalType: 'string', type: 'string' },
      { name: 'symbol', internalType: 'string', type: 'string' },
      { name: 'decimalsArg', internalType: 'uint8', type: 'uint8' },
    ],
...
export const bettingPoolsAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_usdc', internalType: 'address', type: 'address' },
      { name: '_betPoints', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    name: 'betPoints',
    outputs: [
      { name: '', internalType: 'contract ERC20Permit', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    outputs: [
      ...
      { name: 'owner', internalType: 'address', type: 'address' },
      { name: 'option', internalType: 'uint256', type: 'uint256' },
      { name: 'amount', internalType: 'uint256', type: 'uint256' },
      ...
      {
        name: 'outcome',
        internalType: 'enum BettingPools.BetOutcome',
        type: 'uint8',
      },
      {
        name: 'tokenType',
        internalType: 'enum BettingPools.TokenType',
        type: 'uint8',
      },
    ],
    stateMutability: 'view',
  ...
  {
    type: 'function',
    inputs: [{ name: 'betIds', internalType: 'uint256[]', type: 'uint256[]' }],
    name: 'claimPayouts',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      {
        name: 'params',
        internalType: 'struct BettingPools.CreatePoolParams',
        type: 'tuple',
        components: [
          { name: 'question', internalType: 'string', type: 'string' },
          { name: 'options', internalType: 'string[2]', type: 'string[2]' },
          { name: 'betsCloseAt', internalType: 'uint40', type: 'uint40' },
          { name: 'imageUrl', internalType: 'string', type: 'string' },
          { name: 'category', internalType: 'string', type: 'string' },
          { name: 'creatorName', internalType: 'string', type: 'string' },
          { name: 'creatorId', internalType: 'string', type: 'string' },
          { name: 'closureCriteria', internalType: 'string', type: 'string' },
          {
  ...
  },
  {
    ...
    inputs: [
      { name: 'poolId', internalType: 'uint256', type: 'uint256' },
      { name: 'responseOption', internalType: 'uint256', type: 'uint256' },
      { name: 'decisionTime', internalType: 'uint40', type: 'uint40' },
    ],
    name: 'gradeBet',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'permitDeadline', internalType: 'uint256', type: 'uint256' },
      {
        ...
        internalType: 'struct BettingPools.Signature',
        type: 'tuple',
        components: [
          { name: 'v', internalType: 'uint8', type: 'uint8' },
          { name: 'r', internalType: 'bytes32', type: 'bytes32' },
    ...
    name: 'placeBet',
    outputs: [{ name: 'betId', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    ...
    outputs: [
      ...
      { name: 'betsCloseAt', internalType: 'uint40', type: 'uint40' },
      { name: 'decisionTime', internalType: 'uint40', type: 'uint40' },
      { name: 'winningOption', internalType: 'uint256', type: 'uint256' },
      {
        name: 'status',
        internalType: 'enum BettingPools.PoolStatus',
        type: 'uint8',
      },
      { name: 'isDraw', internalType: 'bool', type: 'bool' },
      { name: 'createdAt', internalType: 'uint256', type: 'uint256' },
      { name: 'imageUrl', internalType: 'string', type: 'string' },
      { name: 'category', internalType: 'string', type: 'string' },
      { name: 'creatorName', internalType: 'string', type: 'string' },
      { name: 'creatorId', internalType: 'string', type: 'string' },
      { name: 'closureCriteria', internalType: 'string', type: 'string' },
      { name: 'closureInstructions', internalType: 'string', type: 'string' },
      { name: 'twitterPostId', internalType: 'string', type: 'string' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'userBets',
    outputs: [{ name: 'betIds', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'event',
  ...
  { type: 'error', inputs: [], name: 'DecisionDateNotReached' },
  ...
  { type: 'error', inputs: [], name: 'USDCRefundFailed' },
